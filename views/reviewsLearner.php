            ...
            <div class="custom-block d-flex">
                <div class="">
                    <div class="custom-block-icon-wrap">
                        <div class="section-overlay"></div>
                            <!-- <img src="../public/images/profilepic2.jpg" class="custom-block-image img-fluid" alt=""> -->
                            <?php $mimeType = getMimeType($rating['profilepic']); ?>
                                    <img src="data:<?php echo $mimeType; ?>;base64,<?php echo $rating['profilepic']; ?>" class="logo-image custom-block-image img-fluid" alt="Profile Picture">
                    </div>
