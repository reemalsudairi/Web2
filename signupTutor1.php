                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-12">
                                                    ...
                                                    <div class="form-floating">
                                                        ...
                                                        <label for="first-name">First Name</label><span class="error"><?php echo $errors["firstname"];?></span>
                                                    </div>
                                                    ...
                                                    <div class="form-floating">
                                                        ...
                                                        <label for="email">Email Address</label><span class="error"><?php echo $errors["email"];?></span>
                                                    </div>
                                                    ...
                                                    <div class="form-floating">
                                                        ...
                                                        <label for="city">City</label><span class="error"><?php echo $errors["city"];?></span>
                                                    </div>
                                                    ...
                                                    <div class="form-floating">
                                                        ...
                                                        <label for="phone">Phone Number</label><span class="error"><?php echo $errors["phone"];?></span>
                                                    </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-12"> 
                                                    <div class="form-floating">
                                                        ...
                                                        <label for="last-name">Last Name</label><span class="error"><?php echo $errors["lastname"];?></span>
                                                    </div>
            
                                                    <div class="form-floating">
                                                        <input type="password" name="password" id="password" minlength="8" class="form-control" placeholder="password" required>
                                                        
                                                        <label for="password">Password</label><span class="error"><?php echo $errors["password"];?></span>
                                                    </div>
            
                                                    <div class="form-floating">
                                                        <input type="number" name="age" min="18" id="age" class="form-control" placeholder="age" required>
                                                        
                                                        <label for="age">Age</label><span class="error"><?php echo $errors["age"];?></span>
                                                    ...
                                                    <label for="gender">Gender</label><span class="error"><?php echo $errors["gender"];?></span>
                                                </div>
                                                </div>
                                                ...
                                                <div class="col-lg-12 col-12">
                                                    ...
                                                    <div class="form-floating">
                                                        ...
                                                        <label for="bio">Tell us more about yourself, your spoken languages, and your cultural knowledge!</label><span class="error"><?php echo $errors["bio"];?></span>
                                                    </div>
                                                </div>
